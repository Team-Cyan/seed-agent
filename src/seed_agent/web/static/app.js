  ...
  CN: {
    ...
    pt_filters: {
      ...
      fields: [
        ...
        ["最大下载数", "max_leechers", "optional-number", "高于此下载数时不自动加入；0 或留空表示不限制。"],
  ...
  EN: {
    ...
    pt_filters: {
      ...
      fields: [
        ...
        ["Maximum leechers", "max_leechers", "optional-number", "Skip automatic enqueue above this demand count; 0 or empty means no limit."],
