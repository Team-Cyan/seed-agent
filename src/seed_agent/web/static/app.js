  ...
  CN: {
    ...
    scheduler: {
      ...
      fields: [
        ...
        ["每轮补全 API 预算", "tracker_backfill_max_api_requests", "number", "限制每轮来源补全调用 Tracker API 的次数；未处理任务会按风险和证据时间在后续轮次继续。"],
  ...
  EN: {
    ...
    scheduler: {
      ...
      fields: [
        ...
        ["Backfill API budget", "tracker_backfill_max_api_requests", "number", "Limit Tracker API calls used by source backfill each cycle; remaining tasks rotate into later cycles by risk and evidence age."],
