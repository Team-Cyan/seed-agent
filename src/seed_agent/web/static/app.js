  ...
  CN: {
    ...
    pt_filters: {
      ...
      fields: [
        ...
        ["最大活动下载数", "max_active_downloads", "optional-number", "仅限 seed 刷上传队列；达到上限后拒绝新的 seed 入队，不影响媒体下载。"],
  ...
  EN: {
    ...
    pt_filters: {
      ...
      fields: [
        ...
        ["Maximum active downloads", "max_active_downloads", "optional-number", "Seed upload-farming only. At the limit, reject new seed enqueue without blocking media downloads."],
